...
const PLAYGROUND_PAGE_TABS = ["chat", "agent-builder", "compare", "compliance"] as const;
...
export default function PlaygroundPage() {
  ...
  const [activeTab, onTabChange] = useUrlTab({ tabs: PLAYGROUND_PAGE_TABS, defaultTab: "chat" });
